...
yolov8n_modelPath = "D:\\temp\\ai\\yolov8\\models\\yolov8n.pt"
# yolov8n_modelPath = "D:/temp/ai/yolov8/models/yolov8n.pt"
# coco8_modelPath = "D:\\temp\\ai\\yolov8\\models\\train\\coco8.yaml"
bus_imagePath = "D:\\temp\\ai\\yolov8\\images\\bus.jpg"

# Load a model 加载模型
model = YOLO(yolov8n_modelPath)  # build a new model from scratch 从头开始构建新模型
...
results = model(bus_imagePath)  # predict on an image 对图像进行预测
